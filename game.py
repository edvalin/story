...
pause()
print("Ron, with his fiery red hair and freckles, turned to you with a friendly smile. His voice broke the silence.")
pause()
...
def exitRoom():
    ...
    if isExitRoomVisited:
        ...
        print("As you entered the next room, you found yourselves in a much smaller and dimly lit chamber. This time you noticed a door obstructed by a pile of heavy, seemingly immovable objects. ")
        pause()
    ...
    while userInput not in directions:
        ...
        if userInput == "u":
            if haveWand:
                ...
                pause()
                print("As Hermione's spell took effect, the objects began to levitate one by one, floating gently to the side to create a clear path through the doorway.")
                pause()
                print("Rons face turned slightly red. \"Right, 'Lev-i-o-sa.' Got it.\"")
                pause()
                print("With the path now cleared, you open the door and escape the dungeon.")
                pause()
                print("\"We did it  "+ name + "!\" shouts Harry and you all step outside")
...
def emptyRoom():
    ...
    if isEmptyRoomVisited:
        ...
        print("As you entered the next room, you found yourselves in a surprisingly empty chamber. The room was devoid of any notable features or objects.")
        pause()
        ...
        pause()
        print(" \"Or it could just be a dead end, and we should keep exploring\" Ron Blabed")
        pause()
